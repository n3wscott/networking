...
func TestRewriteHost(ctx context.Context, tt *testing.T) {
	tt.Parallel()
	...
	ing, _, _ := CreateIngressReady(ctx, t, v1alpha1.IngressSpec{
	...
	createExternalNameService(ctx, t, privateHostName, loadbalancerAddress)
